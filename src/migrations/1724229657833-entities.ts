...
export class Entities1724229657833 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "message_stream" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "message_id" character varying(255) NOT NULL, "content" text NOT NULL, "timestamp" bigint NOT NULL, "ended" boolean NOT NULL, CONSTRAINT "PK_d3134df239362c2909106fefa0b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
